...
class PickAndPlaceNode(Node):
    ...
    def pick_and_place_block(self, block_index: int) -> bool:
        ...
        # -- FIX 1: Open gripper wide enough for this block's size.
        #    Larger blocks need the gripper more open before approaching.
        #    open_gripper_joint_positions is set to 0.80 globally, which is
        #    enough for all blocks — just make sure it fully opens.
        ...
        # -- FIX 2: Close gripper to the per-block position for correct grip.
        #    Small blocks need tighter closure, large blocks need looser.
        #    We temporarily update the gripper's closed position then close.
        ...
        # -- FIX 3: Explicitly reset open position before releasing.
        #    Calling open_gripper() alone wasn't enough — the gripper was
        #    holding onto the block. Forcing the position to 0.80 guarantees
        #    a full release.
